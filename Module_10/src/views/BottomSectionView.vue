    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
        <div class="max-w-xl lg:max-w-lg">
          <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">Subscribe to Our Car Deals Newsletter.</h2>
          <p class="mt-4 text-lg leading-8 text-gray-300">Get the latest updates on new car arrivals, special offers, and more. Don't miss out!</p>
        ...
        <dl class="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
          <div class="flex flex-col items-start">
            <dt class="mt-4 font-semibold text-white">Wide Selection</dt>
            <dd class="mt-2 leading-7 text-gray-400">Explore a wide range of new and used cars to suit your preferences.</dd>
          </div>
          <div class="flex flex-col items-start">
            <dt class="mt-4 font-semibold text-white">No Hidden Fees</dt>
            <dd class="mt-2 leading-7 text-gray-400">We believe in transparency and honesty in all our car deals.</dd>
          </div>
        </dl>
      </div>
    </div>
